  ...
  return (
    <div style={{ color: t.text, fontFamily: FONT_B, animation: 'hs-fadeUp 0.3s ease', flex: 1, minHeight: 0, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      <style>{`
        ...
        .hs-wrap  { display: grid; grid-template-columns: minmax(0,1fr) 340px; align-items: start; column-gap: 0; flex: 1; min-height: 0; }
        .hs-main  { flex: 1; min-width: 0; padding: 32px 32px; overflow-y: auto; height: 100%; box-sizing: border-box; }
        .hs-right { width: auto; min-width: 0; padding: 32px 28px 32px 12px; display: flex; flex-direction: column; gap: 14px; overflow-y: auto; height: 100%; box-sizing: border-box; }
