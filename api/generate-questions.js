...
const Y7_MATHS_LEARNING_OBJECTIVES = {
...
const Y7_ENGLISH_LEARNING_OBJECTIVES = {
...
const VIC_Y10_LEARNING_OBJECTIVES = {
...
const VIC_Y10A_LEARNING_OBJECTIVES = {
...
export default async function handler(req, res) {
  ...
  const normalizedSubject =
    resolvedSubject === 'maths_y10' ? 'Year 10 Mathematics' : resolvedSubject
  ...
  const Y10_TOPICS_COMBINED = { ...VIC_Y10_MATHS_TOPICS, ...VIC_Y10A_MATHS_TOPICS }
  const Y10_OBJ_COMBINED    = { ...VIC_Y10_LEARNING_OBJECTIVES, ...VIC_Y10A_LEARNING_OBJECTIVES }

  let topicMap, learningObjectivesMap, curriculumLabel
  ...
  if (isY7Maths) {
    ...
    topicMap = Y10_TOPICS_COMBINED
    learningObjectivesMap = Y10_OBJ_COMBINED
